                                       ...
                                       .then(function (response) {
                                           ...
                                           if (services.length > 0) {
                                               angular.forEach(services, function (service, key) {
                                                   ...
                                                   var newDirective = angular.element('<div service-product class="col-md-6" ng-controller="myController" style="height:200px;float:left;"></div>');
                ...
                if (company != null) {
                    dataFactory.updateServiceProduct(company)
                        .then(function (data) {
                            ...
                            var newDirective = angular.element('<div service-product ng-controller="myController" class="col-md-6" style="height:200px;float:left;"></div>');
