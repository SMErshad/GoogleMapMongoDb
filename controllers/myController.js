                ...
                $(".jRate").jRate({
                    ...
                    onSet: function (score) {
                        ...
                        angular.element('#jRateFinal').on('click', function () {
                            ...
                            var newUserFormAnimatedDirective = angular.element('<div class="row" ng-controller="myController" style="height:100%;"><div id="companyUserComment" when-visible="animateElementIn" class="row car-container" style="height:100%"><div class="row car panel-body" style="height:200px;"><div class="row" id="block" ng-controller="myController"><div class="row"><div class="col-md-2"></div><div class="col-md-8"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green"></i>Would you like to put a comment as well?<i class="fa fa-pencil-square-o" aria-hidden="true" style="color:green"></i></div><div class="col-md-2"></div></div><div class="row"><form class="col-md-8" name="companyCommentForm" ng-controller="myController" ng-submit="addUserComment()" style="margin-left:138px"><textarea class="col-md-10" ng-model="companyComment" form="companyCommentForm" style="background-color:#525c51;padding-left:100px;border:0px;border-radius:2px;" rows="3"></textarea><input  style="background-color:#400606;border:0px" class=" btn btn-danger form-control btn-block" type="submit" value="Add" /></form></div></div></div></div></div>');
