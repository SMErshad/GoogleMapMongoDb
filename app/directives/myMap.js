myApp
    .directive('myMap',['$rootScope','dataFactory', function($rootScope, dataFactory) {
    // directive link function
        var link = function(scope, element, attrs) {
            ...
            scope.initMap = function () {
                ...
                scope.searchMap = '';
                $("#pac-input").css("left", "2%!important");
                ...
                autocomplete.addListener('place_changed', function () {
                    ...
                    $('#gplace').detach();
                    $('#incept').removeClass('col-xs-12');
                    $('#incept').addClass('col-xs-6');

                    if ($("#serviceOrProductPanels div#serviceCollection").html() != '') {
                        $("#serviceOrProductPanels div#serviceCollection").html('');
                    }
                    ...
                    dataFactory.checkCompanyExists(placeID)
                            .then(function (data) {
                                data = $.parseJSON(data.data);
                                scope.checkPlace = data;
                     });
                    if (scope.checkPlace != null) {
                        company = scope.checkPlace;
                    }
