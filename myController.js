...
function ($scope, $compile, dataFactory, $http, $rootScope, $element, $q, $uibModal) {
    ...
    //});
                ...
                dataFactory.searchLocal(query)
                      .then(function (data, status, headers, config, statusText) {
                          ...
                          if (response[0] == null) {
                              ...
                              //var newAnimatedDirective = angular.element('<modal-directive ng-controller="myController" style="height:300px;width:100%"></modal-directive>');
                              //var element = $("#modalDiv").append(newAnimatedDirective);
            ...
            $scope.submitSearch = function (query) {
                ...
                angular.element(document.querySelector('[ng-form="form1"]')).bind("keydown keypress", function (event) {
                    if (event.which === 13) {
